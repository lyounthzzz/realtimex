...
func (x *Proto) GetOperation() int32 {
	if x != nil {
		return x.Operation
	}
	return 0
...
func (x *Proto) GetSendTime() uint64 {
	if x != nil {
		return x.SendTime
	}
	return 0
...
func (x *ProtoAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoAck) ProtoMessage() {}

func (x *ProtoAck) ProtoReflect() protoreflect.Message {
	mi := &file_api_protocol_protocol_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ProtoAck) GetSendTime() uint64 {
	if x != nil {
		return x.SendTime
	}
	return 0
...
var file_api_protocol_protocol_proto_rawDesc = []byte{
	...
	,
	...
	0x28, 0x04, 0x52, 0x08, 0x73, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x33, 0x5a, 0x31,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x79, 0x6f, 0x75, 0x6e,
	0x74, 0x68, 0x7a, 0x7a, 0x7a, 0x2f, 0x72, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x78, 0x2f,
...
var file_api_protocol_protocol_proto_goTypes = []interface{}{
	(*Proto)(nil),    // 0: realtimex.protocol.Proto
	(*ProtoAck)(nil), // 1: realtimex.protocol.ProtoAck
}
