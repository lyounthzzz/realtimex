...
type AuthnServiceClient interface {
	DoAuthn(ctx context.Context, in *DoAuthNRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *authnServiceClient) DoAuthn(ctx context.Context, in *DoAuthNRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/realtimex.gateway.AuthnService/DoAuthn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthnServiceServer interface {
	DoAuthn(context.Context, *DoAuthNRequest) (*User, error)
...
func (UnimplementedAuthnServiceServer) DoAuthn(context.Context, *DoAuthNRequest) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DoAuthn not implemented")
}
...
func _AuthnService_DoAuthn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DoAuthNRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthnServiceServer).DoAuthn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realtimex.gateway.AuthnService/DoAuthn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthnServiceServer).DoAuthn(ctx, req.(*DoAuthNRequest))
	}
...
var AuthnService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DoAuthn",
			Handler:    _AuthnService_DoAuthn_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/gateway/gateway.proto",
